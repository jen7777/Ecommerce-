...
class Order(models.Model):
    ...
    def __str__(self):
        return str(self.orderID)      #as id is integer, need to be converted into string
...
class ShippingAddress(models.Model):
    ...
    orderID=models.ForeignKey(Product,on_delete=models.SET_NULL,null=True,blank=True)
